<template>
  <div class="bg-white px-6 py-32 lg:px-8 dark:bg-gray-900 min-h-screen">
    <div class="mx-auto max-w-3xl text-base/7 text-gray-700 dark:text-gray-300">
      <p class="text-base/7 font-semibold text-indigo-600 dark:text-indigo-400">Introducing</p>
      <h1 class="mt-2 text-4xl font-semibold tracking-tight text-pretty text-gray-900 sm:text-5xl dark:text-white">JavaScript for beginners</h1>
      ...
      <div class="mt-10 max-w-2xl text-gray-600 dark:text-gray-400">
        ...
        <ul role="list" class="mt-8 max-w-xl space-y-8 text-gray-600 dark:text-gray-400">
          <li class="flex gap-x-3">
            ...
            <span><strong class="font-semibold text-gray-900 dark:text-white">Data types.</strong> Lorem ipsum, dolor sit amet consectetur adipisicing elit. Maiores impedit perferendis suscipit eaque, iste dolor cupiditate blanditiis ratione.</span>
          </li>
          <li class="flex gap-x-3">
            <CheckCircleIcon class="mt-1 size-5 flex-none text-indigo-600 dark:text-indigo-400" aria-hidden="true" />
            <span><strong class="font-semibold text-gray-900 dark:text-white">Loops.</strong> Anim aute id magna aliqua ad ad non deserunt sunt. Qui irure qui lorem cupidatat commodo.</span>
          </li>
          <li class="flex gap-x-3">
            <CheckCircleIcon class="mt-1 size-5 flex-none text-indigo-600 dark:text-indigo-400" aria-hidden="true" />
            <span><strong class="font-semibold text-gray-900 dark:text-white">Events.</strong> Ac tincidunt sapien vehicula erat auctor pellentesque rhoncus. Et magna sit morbi lobortis.</span>
          </li>
        </ul>
        <p class="mt-8">Et vitae blandit facilisi magna lacus commodo. Vitae sapien duis odio id et. Id blandit molestie auctor fermentum dignissim. Lacus diam tincidunt ac cursus in vel. Mauris varius vulputate et ultrices hac adipiscing egestas. Iaculis convallis ac tempor et ut. Ac lorem vel integer orci.</p>
        <h2 class="mt-16 text-3xl font-semibold tracking-tight text-pretty text-gray-900 dark:text-white">From beginner to expert in 3 hours</h2>
        ...
        <figure class="mt-10 border-l border-indigo-600 pl-9 dark:border-indigo-400">
          ...
          <figcaption class="mt-6 flex gap-x-4">
            <img class="size-6 flex-none rounded-full bg-gray-50 dark:bg-gray-800" src="https://images.unsplash.com/photo-1502685104226-ee32379fefbe?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" alt="" />
            <div class="text-sm/6"><strong class="font-semibold text-gray-900 dark:text-white">Maria Hill</strong> – Marketing Manager</div>
          </figcaption>
        </figure>
      ...
      <figure class="mt-16">
        <img class="aspect-video rounded-xl bg-gray-50 object-cover dark:bg-gray-800" src="https://images.unsplash.com/photo-1500648767791-00dcc994a43e?ixlib=rb-1.2.1&auto=format&fit=facearea&w=1310&h=873&q=80&facepad=3" alt="" />
